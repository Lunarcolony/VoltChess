      ...
      >
        ...
        >
          ...
          <Grid item xs={12} md={6}>
            ...
            >
              Free, instant, AI-powered chess analysis. Upload your PGN and get blunders, inaccuracies, and best moves—no account needed.
            </Typography>
            <Box mt={4}>
              <LoadGameButton
                ...
                sx={{
                  ...
                  px: 5,
                  py: 2,
                  background: 'linear-gradient(90deg, #232526 0%, #3b9ac6 60%, #7fddff 100%)',
                  color: '#fff',
                  ...
                  transition: 'all 0.2s',
                  '&:hover': {
                    background: 'linear-gradient(90deg, #3385ad 0%, #3b9ac6 80%, #7fddff 100%)',
              ...
              <Grid item xs={12} sm={6}>
                ...
                >
                  ...
                  <Typography color="text.secondary" fontSize="1rem">
                    Powerful, user-friendly PGN analysis for all levels. Learn, grow, and dominate your games.
                  </Typography>
                </Box>
              </Grid>
              <Grid item xs={12} sm={6}>
                ...
                >
                  ...
                  <Typography color="text.secondary" fontSize="1rem">
                    Instant results, engine-powered backend, and clear feedback—faster than traditional chess sites.
                  </Typography>
                </Box>
              </Grid>
              <Grid item xs={12} sm={6}>
                ...
                >
                  ...
                  <Typography color="text.secondary" fontSize="1rem">
                    No signup, no paywall, no limits. Just upload your PGN and start analyzing.
                  </Typography>
                </Box>
              </Grid>
              <Grid item xs={12} sm={6}>
                ...
                >
                  ...
                  <Typography color="text.secondary" fontSize="1rem">
                    VoltChess is the perfect free alternative to Chess.com Game Review—no ads, no subscriptions.
                  </Typography>
                </Box>
              </Grid>
            </Grid>
